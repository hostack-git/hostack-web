...
export const CONTENT = {
  ...
  caseStudy: {
    eyebrow: 'Case Study · #0',
    headline: '24 minutes saved. Per day. Per volunteer briefing.',
    ...
    before: [
      'Daily briefing: 2–4 min per volunteer, sent manually via WhatsApp',
      'New arrivals: 2–3 days to get up to speed',
      'Guest requests buried in group chat history',
      'Manager tied to phone every morning',
    ],
    after: [
      'Staff App auto-briefing — 30 seconds to read, nothing to send',
      'Volunteer onboarding via QR code — under 1 hour',
      'Requests routed automatically to staff task list',
      'Morning dashboard: one glance, full picture',
    ],
    metrics: [
      { value: '24 min/day', label: 'Saved on volunteer briefings (12 volunteers × 2 min)' },
      { value: '~6.7 hrs',   label: 'Manager time freed per month' },
      { value: '<1 hr',      label: 'New volunteer onboarding time' },
      { value: '100%',       label: 'Team adoption — nobody dropped off' },
    ],
    liveProof: {
